...
namespace BasePlugin\Engine;

use BasePlugin\Engine;

/**
 * BasePlugin Initializer
 */
class Initialize {
    ...
    private function load_classes() {
        $this->classes = \apply_filters( 'BasePlugin_classes_to_execute', $this->classes );
        ...
        foreach ( $this->classes as $class ) {
            try {
                ...
                \do_action( 'BasePlugin_initialize_failed', $err );
    ...
    private function get_classes( string $namespace ) {
        ...
        $namespace = 'BasePlugin\\' . $namespace;

        // In case composer has autoload optimized
        if ( isset( $classmap[ 'BasePlugin\\Engine\\Initialize' ] ) ) {
